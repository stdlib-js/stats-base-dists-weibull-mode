...
tape( 'if provided `0 < k <= 1` and `lambda > 0`, the function returns `0`', opts, function test( t ) {
	var y;

	y = mode( 0.3, 2.0 );
	t.equal( y, 0.0, 'returns NaN' );
...
tape( 'the function returns the mode of a Weibull distribution', opts, function test( t ) {
	var expected;
	var lambda;
	var delta;
	var tol;
