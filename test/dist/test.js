...
tape( 'if provided `0 < k <= 1` and `lambda > 0`, the function returns `0`', function test( t ) {
	var y;
...
tape( 'the function returns the mode of a Weibull distribution', function test( t ) {
	var expected;
	var lambda;
	var delta;
	var tol;
